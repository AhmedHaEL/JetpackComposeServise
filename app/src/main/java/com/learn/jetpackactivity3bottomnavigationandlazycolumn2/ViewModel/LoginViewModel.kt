...
//    val hasScreenBeenShown = remember { mutableStateOf(false) }

//    var go by remember { mutableStateOf(true) }
//    var go : Boolean = false


    fun performLogin(username: String, password: String, navigation: NavController,context : Context) {
...
//        val apiLogin = retrofit.create(ApiLogin::class.java)
        ...
        val apiLogin = ApiService.getInstance()
